...
const getSignup = (req, res) => {
    return res.sendFile(path.join(__dirname, "../dist/login/signup.html"))
}
...
const getSignin = (req, res) => {
    return res.sendFile(path.join(__dirname, "../dist/login/signin.html"))
}


module.exports = { homePage, signup, getSignup, signin, getSignin }